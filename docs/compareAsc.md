...
$result = DateFns::compareAsc(dateLeft: new DateTimeImmutable('1987-02-11 00:00:00'), dateRight: new DateTimeImmutable('1989-07-10 00:00:00'));
// => -1
```
...
usort($result, [DateFns::class, 'compareAsc']);
// => [
