...
class IsBeforeTest extends TestCase {
	 ...
	 * @test
	 */
	public function returns_true_if_first_date_is_before_second_one(): void {
		$date = new DateTimeImmutable('1987-02-11');
		$dateToCompare = new DateTimeImmutable('1989-07-10');

		$result = DateFns::isBefore($date, $dateToCompare);
	 ...
	 * @test
	 */
	public function returns_false_if_first_date_is_after_second_one(): void {
